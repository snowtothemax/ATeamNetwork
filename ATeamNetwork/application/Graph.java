...
/**
 * A Graph Object that is used as an abstract data type to organize data by creating Verticies that
 * represent that data to be stored, connecting each Vertex with an Edge that creates a path, which
...
public class Graph implements GraphADT {
  ...
  /**
   * A GraphNode object represents a vertex in the GraphADT. Each node contains the data to be
   * stored as a vertex, the list of all neighboring vertices, and it's index in the adjacency
   * matrix.
   * 
   ...
   */
  /**
   * Constructs and initializes a Graph object. The adjacency matrix is initialized to 100 indices
  ...
  /**
   * Removes the GraphNode of the input vertex from the graph. It also removes it from the
   * nighborlist of each node it had in its neighbor list
   * 
   * @param vert - the vertex to be found in the graph.
